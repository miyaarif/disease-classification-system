...
def checkdisease(request):
    ...
    if request.method == "POST":
            ...
            if (h == 'yes'):
                ...
                # diseasename = predicted
                # diseasename = disease[a]
                # no_of_symp = 3.0
                # symptomsname = psymptoms
                # confidence = confidencescore
                # diseaseinfo_new = diseaseinfo(user=user, diseasename=diseasename, no_of_symp=no_of_symp, symptomsname=symptomsname, confidence=confidence)
            ...
            # else:
                ...
                # messages.success(request, "No disease")
